...
// Pokemon names (indexed by Pokedex number)
export const POKEMON_NAMES = [
  null, 'BULBASAUR', 'IVYSAUR', 'VENUSAUR', 'CHARMANDER', 'CHARMELEON', 'CHARIZARD',
  ...
  'NIDORAN_F', 'NIDORINA', 'NIDOQUEEN', 'NIDORAN_M', 'NIDORINO', 'NIDOKING', 'CLEFAIRY',
  ...
  'SLOWBRO', 'MAGNEMITE', 'MAGNETON', 'FARFETCH_D', 'DODUO', 'DODRIO', 'SEEL', 'DEWGONG',
